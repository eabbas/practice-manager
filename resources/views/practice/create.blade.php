        ...
        <form action="{{ url('practice/store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-gray-700 font-medium mb-3 flex items-center">
                            ...
                            عنوان تمرین <span class="text-red-500 mr-1">*</span>
                        </label>
                    ...
                    <div>
                        <label class="block text-gray-700 font-medium mb-3 flex items-center">
                            <i class="fas fa-book-open ml-2 text-[#023e83] text-sm"></i>
                            مهلت تحویل تمرین <span class="text-red-500 mr-1">*</span>
                        </label>

                        <div class="relative">
                            <input type="date" name="deadLine" required
                                value="{{$lesson->practices}}"
                                class="w-full px-4 py-3 pr-12 bg-gray-50 rounded-xl
                                       border border-gray-300 transition
                                       focus:border-[#023e83]
                                       appearance-none">
            ...
            <div class="mb-8">
                ...
                <div class="relative">
                    ...
                    <div class="flex flex-row gap-4 justify-start pt-6 border-t border-gray-200">
                        <label class="block text-gray-700 font-semibold mt-5">انتخاب فایل:</label>
                        <input type="file" name="file[]" multiple
                            class="border border-gray-300 rounded-lg px-3 py-2 w-55
                                   focus:outline-none focus:ring-0 mt-3 bg-gray-50 cursor-pointer">
                    </div>
                </div>
            </div>
