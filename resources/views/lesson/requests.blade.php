              ...
              <table class="w-full text-right">
                  ...
                  <tbody class="text-sm">
                      ...
                      <tr class="hover:bg-slate-50">
                          ...
                          <td class="py-3 px-4">{{$lesson->code}}</td>
                          <td class="py-3 px-4">{{$lesson->title}}</td>
                          <td class="py-3 px-4">{{$lesson->master}}</td>
                          <td class="py-3 px-4 text-center">
                              <button class="px-3 py-1.5 rounded-md border border-blue-600 text-blue-600 hover:bg-blue-50">
                                  تایید
                              </button>
                          </td>
                      </tr>
